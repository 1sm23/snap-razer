...
const enMessages = {
  ...
  "connection.connectedStatus": "{device} connected",
  "connection.disconnectedStatus": "No Razer device connected",
  ...
  "buttonMap.description": "Assign onboard actions to the buttons most Razer mice expose.",
  "buttonMap.firmwareNotice":
    "This device did not expose the verified onboard button protocol. Changes remain a local draft.",
  "buttonMap.deviceNotice":
    "Apply writes the normal-layer assignments to onboard memory and verifies each button by reading it back. Fully exit Razer Synapse first.",
  "buttonMap.localDraft": "Local draft",
  "buttonMap.deviceProfile": "Onboard profile",
  "buttonMap.apply": "Apply",
  "buttonMap.applying": "Applying...",
  "buttonMap.applyUnavailable": "Apply unavailable",
  "buttonMap.applied": "Button mappings applied",
  "buttonMap.appliedDescription": "Every assignment was written to onboard memory and verified.",
  ...
  "performance.dpiStageGroup": "DPI stage {stage}, {state}, {value}",
  "performance.dpiStageActive": "active",
  "performance.dpiStageInactive": "inactive",
  "performance.dpiStageValue": "{value} DPI",
  "performance.dpiStageSplitValue": "{x}:{y} DPI",
  "performance.activateDpiStage": "Activate DPI stage {stage}, {value}",
  "performance.stageAxisNumber": "DPI stage {stage} {axis} number",
  "performance.stageAxisSlider": "DPI stage {stage} {axis} slider",
  ...
  "mouseTest.chartLabel": "Polling rate history chart",
  "mouseTest.statsLabel": "Mouse test stats: rate {rate}, peak {peak}, jitter {jitter}, interval {interval}, speed {speed}, position {position}",
  "mouseTest.peak": "Peak",
  ...
  "advanced.dynamicSensitivity.curvePreview": "Dynamic sensitivity curve preview",
  ...
  "advanced.rotationPreview": "Rotation preview, current angle {angle} degrees",
  ...
  "capability.detail.buttons.available": "Onboard button assignments can be read, written, and verified.",
...
const zhCNMessages: Record<MessageKey, string> = {
  ...
  "connection.connectedStatus": "{device} 已连接",
  "connection.disconnectedStatus": "未连接雷蛇设备",
  "controls.title": "控制",
  ...
  "buttonMap.description": "为大多数雷蛇鼠标会暴露的按键分配板载动作。",
  "buttonMap.firmwareNotice":
    "此设备未暴露已经验证的板载按键协议，下面的改动只会保存在本地草稿中。",
  "buttonMap.deviceNotice": "应用会把普通层按键分配写入板载内存，并逐键回读验证。请先完全退出雷云。",
  "buttonMap.localDraft": "本地草稿",
  "buttonMap.deviceProfile": "板载配置",
  "buttonMap.apply": "应用",
  "buttonMap.applying": "应用中...",
  "buttonMap.applyUnavailable": "暂不能应用",
  "buttonMap.applied": "按键映射已应用",
  "buttonMap.appliedDescription": "所有按键分配均已写入板载内存并通过回读验证。",
  ...
  "performance.dpiStageGroup": "DPI 档位 {stage}，{state}，{value}",
  "performance.dpiStageActive": "当前档位",
  "performance.dpiStageInactive": "非当前档位",
  "performance.dpiStageValue": "{value} DPI",
  "performance.dpiStageSplitValue": "{x}:{y} DPI",
  "performance.activateDpiStage": "激活 DPI 档位 {stage}，{value}",
  "performance.stageAxisNumber": "DPI 档位 {stage} {axis} 数字输入",
  "performance.stageAxisSlider": "DPI 档位 {stage} {axis} 滑块",
  ...
  "mouseTest.chartLabel": "轮询率历史图表",
  "mouseTest.statsLabel": "鼠标测试统计：轮询率 {rate}，峰值 {peak}，抖动 {jitter}，间隔 {interval}，速度 {speed}，位置 {position}",
  "mouseTest.peak": "峰值",
  "mouseTest.jitter": "抖动",
  ...
  "advanced.dynamicSensitivity.curvePreview": "动态灵敏度曲线预览",
  ...
  "advanced.rotationPreview": "旋转预览，当前角度 {angle} 度",
  ...
  "capability.detail.buttons.available": "可以读取、写入并回读验证板载按键分配。",
