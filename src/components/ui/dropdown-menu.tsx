...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger ref={ref} className={cn("ui-dropdown-sub-trigger", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem ref={ref} className={cn("ui-dropdown-radio-item", className)} {...props}>
